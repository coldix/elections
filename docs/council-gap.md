# Legislative Council — ticket / recontest gap

**Purpose.** Sitting MLCs (and known ticket work) for Victorian 2026 upper house.
...
| south-eastern-metropolitan | labor | Michael Galea |
| south-eastern-metropolitan | legalise-cannabis | Rachel Payne |
...
1. Find a named source that the person (or party) is standing on a region ticket.
2. Add `data/vic2026/candidates/<region>--<slug>.yaml` with `chamber: council`.
3. Prefer party ticket announcements over Wikipedia.

## Recorded Council candidacies (any status)

- `western-metropolitan--deeming-moira.yaml` — Moira Deeming (disendorsed)
- `western-metropolitan--gourisetty-dinesh.yaml` — Dinesh Gourisetty (withdrawn)

...
| Insightfully / MCA NSW uranium + VI (Aug 2026) | 2026-09-22 (encoded out of average) | MCA-commissioned Insightfully (5–12 Aug 2026, n=1000). VI encoded under `data/nsw2027/polls/insightfully-2026-08-mca.yaml` with `eligible_for_average: false` (advocacy). MCA release is issues-led; VI topline from One News write-up of the MCA pack. Uranium awareness/support figures not encoded as VI. |
